...
::: {.viz-grid}
<div class="viz-card"><img src="../images/projects/lung-cancer/survival-by-stage.png" alt="Two-year survival by SEER stage"><p><strong>Stage dominates survival.</strong> Localized disease had a 65.6% two-year survival rate versus 12.0% for distant disease.</p></div>
<div class="viz-card"><img src="../images/projects/lung-cancer/odds-ratio-drivers.png" alt="Logistic regression odds ratios for two-year survival"><p><strong>The model is interpretable.</strong> Stage, sex, race, lymph nodes, and tumor size are surfaced as transparent survival drivers.</p></div>
:::
